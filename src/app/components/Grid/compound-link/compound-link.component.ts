...
export class CompoundLinkComponent extends AbstractInteractiveComponent {
  ...
  override registerInteractor(): Interactor {
    return new CompoundLinkInteractor(this.compoundLink, this.stateService, this.notificationService, this.getCompoundDrawnPath());
  }
  ...
  getColor():string{
    ...
    return this.svgPathService.calculateCompoundPath(this.compoundLink.links, radius);
  }
