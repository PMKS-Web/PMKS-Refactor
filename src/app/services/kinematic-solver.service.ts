...
export class PositionSolverService {
    ...
    private minDistanceFromGround(input: Joint, subMechanism: Map<Joint, RigidBody[]>, visitedJoints: number[] = []): number {
    ...
    private solveNextJointPosition(prevPositions: Coord[], solveOrder: number[], solvePrerequisite: SolvePrerequisite, movingForward: number, nextPositions: Coord[]): Coord | undefined {
        switch (solvePrerequisite.solveType) {
            ...
            case SolveType.CircleCircle:
                return this.solveCircleCircle(prevPositions, solveOrder, solvePrerequisite, nextPositions);

            case SolveType.CircleLine:
                console.log("Solving Circle Line");
                return this.solveCircleLine(prevPositions, solveOrder, solvePrerequisite, nextPositions);
    ...
    private solveCircleCircle(prevPositions: Coord[], solveOrder: number[], solvePrerequisite: SolvePrerequisite, nextPositions: Coord[]): Coord | undefined {
    ...
    private solveCircleLine(prevPositions: Coord[], solveOrder: number[], solvePrerequisite: SolvePrerequisite, nextPositions: Coord[]): Coord | undefined {
